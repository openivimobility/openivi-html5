...
var len__6226__auto___16818 = arguments.length;
var i__6227__auto___16819 = (0);
while(true){
if((i__6227__auto___16819 < len__6226__auto___16818)){
args__6233__auto__.push((arguments[i__6227__auto___16819]));

var G__16820 = (i__6227__auto___16819 + (1));
i__6227__auto___16819 = G__16820;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__16816){
var vec__16817 = p__16816;
var opts = cljs.core.nth.call(null,vec__16817,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__16817,opts){
return (function (evt){
...
});})(conn,vec__16817,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__16817,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__16817,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__16817,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq16814){
var G__16815 = cljs.core.first.call(null,seq16814);
var seq16814__$1 = cljs.core.next.call(null,seq16814);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__16815,seq16814__$1);
});
